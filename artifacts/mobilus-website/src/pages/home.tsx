...
export default function Home() {
  ...
  const categories = [
    ...
    {
      title: t.home.cat_fitness,
      desc: t.home.cat_fitness_desc,
      href: "/contact",
            ...
            {categories.map((cat, i) => (
              <Link key={i} href={cat.href}>
                <motion.div
                  ...
                  className={`group relative overflow-hidden rounded-none bg-card cursor-pointer ${
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-60">
            <h3 className="text-2xl font-black italic tracking-tighter">
              IN<span className="text-primary">CREDIT</span> GROUP
            </h3>
            <h3 className="text-2xl font-black tracking-widest">
              UNO<span className="font-light text-primary">LEASING</span>
            </h3>
